...
class ImageMapper():
    ...
    def vector2image(self, pixels, camera_type):
        """
        ...
        """
        # translate camera_type if needed
        if camera_type in DIRTY_HACK:
            camera_type = DIRTY_HACK[camera_type]
    ...
    def __read_pix_pos_from_fits(self, camera_type):
        ...
        if camera_type in self.num_pixels.keys():
            ...
            infile = os.path.join("/home/jsevilla/ctalearn_keras/ctalearn/data","pixel_pos_files/{}.camgeom.fits".format(camera_type))
